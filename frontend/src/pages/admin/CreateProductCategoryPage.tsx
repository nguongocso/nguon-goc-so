...
export const CreateProductCategoryPage: React.FC = () => {
  ...
  const onSubmit = async (values: FormValues) => {
    ...
    try {
      ...
      toast.error(error.response?.data?.message || "Có lỗi xảy ra khi tạo loại nông sản");
    }
  };
    ...
    <div className="space-y-6">
      <div className="flex flex-col sm:flex-row sm:items-center sm:justify-between gap-4">
        <div>
          ...
          <p className="text-sm text-muted-foreground mt-1">
            Khai báo loại nông sản dùng chung và thiết lập ngưỡng nhiệt độ, độ ẩm bảo quản.
          </p>
        </div>
      ...
      <Card className="rounded-xl border-slate-200 bg-white shadow-sm">
        <CardHeader className="border-b border-slate-100 pb-4">
          ...
          <CardDescription>
            Điền thông tin cơ bản về loại nông sản và các điều kiện môi trường bảo quản tiêu chuẩn.
          </CardDescription>
        </CardHeader>
