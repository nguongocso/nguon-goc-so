  ...
  const handleSearch = async (e?: React.FormEvent) => {
    ...
    try {
      ...
      const msg =
        ...
        err.message ||
        'Mã truy vết không tồn tại trên hệ thống. Vui lòng kiểm tra lại.';
      setErrorMsg(msg);
    } finally {
      setLoading(false);
    }
          ...
          <div className="grid grid-cols-1 sm:grid-cols-2 lg:grid-cols-4 gap-4">
            ...
            <div className="bg-white p-5 rounded-xl border border-slate-200 shadow-sm">
              ...
              <p className="text-2xl font-bold text-slate-900 mt-1">
                {traceData.summary.totalActivatedStamps.toLocaleString()}
              </p>
            </div>
            ...
            <div className="bg-white p-5 rounded-xl border border-slate-200 shadow-sm">
              ...
              <p className="text-2xl font-bold text-slate-900 mt-1">
                {traceData.summary.totalReceivingOrganizations}
              </p>
            </div>
            ...
            <div className="bg-white p-5 rounded-xl border border-slate-200 shadow-sm">
              ...
              <p className="text-2xl font-bold text-slate-900 mt-1">
                {traceData.summary.totalRecalledShipments}
              </p>
            </div>
          </div>
              ...
              <div className="bg-white p-5 rounded-xl border border-blue-200 shadow-sm border-l-4 border-l-blue-500">
                <div className="flex items-center justify-between">
                  ...
                  <span
                    className={`text-xs px-2 py-0.5 rounded font-semibold ${
                      traceData.productionLot.status === 'APPROVED'
                ...
                <div className="text-xs text-slate-600 mt-2 space-y-1.5">
                  <p>
                    Sản lượng:{' '}
                    <strong>
                      {traceData.productionLot.expectedQuantity} {traceData.productionLot.expectedQuantityUnit}
                    </strong>
                  </p>
              ...
              {traceData.farmArea ? (
                <div className="bg-white p-5 rounded-xl border border-emerald-200 shadow-sm border-l-4 border-l-emerald-500">
                  ...
                  <div className="text-xs text-slate-500 mt-2 space-y-1">
                    <p>
                      <span className="font-medium text-slate-700">Mã vùng:</span> {traceData.farmArea.code}
                    </p>
                    <p>
                      <span className="font-medium text-slate-700">Vị trí:</span> {traceData.farmArea.location}
                    </p>
                    {traceData.farmArea.areaSize && (
                      <p>
                        <span className="font-medium text-slate-700">Diện tích:</span> {traceData.farmArea.areaSize} m²
                      </p>
                    )}
                  </div>
                </div>
            ...
            <div className="lg:col-span-8 space-y-4">
              <div className="flex items-center justify-between px-1">
                <h2 className="font-bold text-sm text-slate-900">
                  Chiều xuôi (downstream) · phạm vi ảnh hưởng
                </h2>
                      ...
                      <div className="grid grid-cols-2 sm:grid-cols-3 gap-3 my-4">
                        ...
                        <div className="bg-slate-50 p-2.5 rounded-lg text-xs border border-slate-100">
                          ...
                          <span className="font-bold text-slate-800">
                            {ship.activatedStampsCount.toLocaleString()} tem
                          </span>
                        </div>
