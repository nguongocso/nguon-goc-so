...
export const ProfileTemplateFormPage: React.FC = () => {
  ...
  const previewMockData = useMemo(() => {
      ...
      mock.farmLogs = [
        {
          ...
          notes: selectedKeySet.has('farmLog.notes') ? 'Gieo hạt vụ thu đông, độ ẩm đất 75%, xử lý vi sinh Trichoderma' : undefined,
        ...
        },
        {
          ...
          notes: selectedKeySet.has('farmLog.notes') ? 'Tưới phun mưa tự động duy trì độ ẩm 70%, làm sạch cỏ luống' : undefined,
        ...
        },
        {
          ...
          notes: selectedKeySet.has('farmLog.notes') ? 'Bón thúc lần 1 giai đoạn cây phát triển thân lá và rễ củ' : undefined,
        ...
        },
        {
          ...
          notes: selectedKeySet.has('farmLog.notes') ? 'Phun phòng ngừa sâu tơ và rệp muội định kỳ theo quy trình VietGAP' : undefined,
          attachments: selectedKeySet.has('farmLog.attachments') ? ['NhatKy_ChePhamSinhHoc.pdf'] : undefined,
        },
        {
          ...
          unit: selectedKeySet.has('farmLog.unit') ? 'kg' : undefined,
          notes: selectedKeySet.has('farmLog.notes') ? 'Bón thúc lần 2 nuôi củ, tăng tích lũy đường và màu sắc tự nhiên' : undefined,
          attachments: selectedKeySet.has('farmLog.attachments') ? ['PhieuXuatKho_PhanBon.pdf'] : undefined,
        },
        {
          ...
          material: selectedKeySet.has('farmLog.material') ? 'Không sử dụng vật tư (Cách ly 15 ngày)' : undefined,
          quantity: undefined,
          unit: undefined,
          notes: selectedKeySet.has('farmLog.notes') ? 'Kiểm tra độ chín đồng đều và đảm bảo cách ly an toàn trước thu hoạch' : undefined,
          attachments: selectedKeySet.has('farmLog.attachments') ? ['BienBan_KiemTraCachLy.pdf'] : undefined,
        },
      ];
    }
    ...
    if (hasCertifications) {
      mock.certifications = [
        ...
        {
          name: selectedKeySet.has('certification.name') ? 'Chứng nhận Chuỗi Cung ứng Thực phẩm An toàn' : undefined,
          ...
          certifier: selectedKeySet.has('certification.certifier') ? 'Chi cục Trồng trọt & BVTV Lâm Đồng' : undefined,
        },
      ];
    }
      ...
      mock.inspections = [
        {
          ...
          criterionName: selectedKeySet.has('inspection.criterionName') ? 'Kim loại nặng trong đất & nước (Pb, Cd)' : undefined,
        ...
        },
        {
          ...
          inspectionUnit: selectedKeySet.has('inspection.inspectionUnit') ? 'Trung tâm Phân tích Quatest 3' : undefined,
          criterionName: selectedKeySet.has('inspection.criterionName') ? 'Dư lượng Nitrat (NO3-) trên nông sản' : undefined,
          passed: selectedKeySet.has('inspection.passed') ? 'Đạt' : undefined,
          status: selectedKeySet.has('inspection.passed') ? 'Đạt' : undefined,
        ...
        },
        {
          sampleSentDate: selectedKeySet.has('inspection.sampleSentDate') ? '2026-09-08' : undefined,
          inspectionUnit: selectedKeySet.has('inspection.inspectionUnit') ? 'Trung tâm Phân tích Quatest 3' : undefined,
          criterionName: selectedKeySet.has('inspection.criterionName') ? 'Dư lượng thuốc BVTV (Cypermethrin, Chlorpyrifos)' : undefined,
        ...
        },
        {
          sampleSentDate: selectedKeySet.has('inspection.sampleSentDate') ? '2026-09-08' : undefined,
          inspectionUnit: selectedKeySet.has('inspection.inspectionUnit') ? 'Trung tâm Phân tích Quatest 3' : undefined,
          criterionName: selectedKeySet.has('inspection.criterionName') ? 'Vi sinh vật gây hại (Salmonella, E.coli)' : undefined,
          passed: selectedKeySet.has('inspection.passed') ? 'Đạt' : undefined,
          status: selectedKeySet.has('inspection.passed') ? 'Đạt' : undefined,
          resultDate: selectedKeySet.has('inspection.resultDate') ? '2026-09-09' : undefined,
          expiryDate: selectedKeySet.has('inspection.expiryDate') ? '2027-03-09' : undefined,
      ...
      mock.timelineEvents = [
        {
          ...
          eventData: selectedKeySet.has('chainEvent.eventData') ? 'Sản lượng: 2500 kg; Thu hoạch thủ công sáng sớm, sơ tuyển củ loại 1' : undefined,
        ...
        },
        {
          ...
          eventData: selectedKeySet.has('chainEvent.eventData') ? 'Vận chuyển về trạm sơ chế bằng xe chuyên dụng 49C-123.45; Nhiệt độ: 20°C' : undefined,
        ...
        },
        {
          ...
          eventData: selectedKeySet.has('chainEvent.eventData') ? 'Rửa sạch sục khí Ozone diệt khuẩn, làm ráo tự nhiên; Phân loại củ 16-20cm' : undefined,
        ...
        },
        {
          ...
          location: selectedKeySet.has('chainEvent.location') ? '11.8350, 108.4570' : undefined,
          eventData: selectedKeySet.has('chainEvent.eventData') ? 'Kiểm tra cảm quan độ giòn tươi và test nhanh tồn dư nitrate; Đạt 100% chuẩn xuất hàng' : undefined,
        ...
        },
        {
          ...
          location: selectedKeySet.has('chainEvent.location') ? '11.8350, 108.4570' : undefined,
          eventData: selectedKeySet.has('chainEvent.eventData') ? 'Số thùng: 200; Quy cách: Thùng carton chuyên dụng 10kg, bọc màng PE thoáng khí, dán tem QR GS1' : undefined,
        ...
        },
        {
          ...
          location: selectedKeySet.has('chainEvent.location') ? '11.8350, 108.4570' : undefined,
          eventData: selectedKeySet.has('chainEvent.eventData') ? 'Kích hoạt 200 mã định danh tem QR GS1 công khai trên Cổng thông tin Nguồn Gốc Số' : undefined,
          recordedBy: selectedKeySet.has('chainEvent.recordedBy') ? 'Nguyễn Văn Quản Lý' : undefined,
        },
        {
          ...
          eventData: selectedKeySet.has('chainEvent.eventData') ? 'Bàn giao xe container lạnh 49A-888.99 giao Đại siêu thị Go! Đà Lạt; Nhiệt độ thùng: 8°C - 12°C' : undefined,
        ...
        },
        {
          ...
          eventData: selectedKeySet.has('chainEvent.eventData') ? 'Đại siêu thị Go! Đà Lạt nghiệm thu quét mã QR, xác nhận nhập kho 200 thùng và phân phối lên kệ' : undefined,
  ...
  return (
    <div className="space-y-6">
      ...
      {/* Modal xuất / xem trước hồ sơ đồng bộ dạng form xuất như ở danh sách lô hàng */}
      <ExportDossierDialog
        ...
        templateInfo={{
          ...
          selectedFieldKeys: selectedFields.map((f) => f.fieldKey),
