          ...
          <div className="flex items-center justify-between flex-wrap gap-2">
            <div className="flex items-center gap-2">
              ...
              <CardTitle className="text-base font-semibold">
                Cấu hình ghi đè theo loại nông sản
              </CardTitle>
            ...
            <Button onClick={handleAdd} size="sm" className="bg-emerald-600 hover:bg-emerald-700 text-white shadow-xs">
              <Plus className="h-4 w-4 mr-1.5" />
              Thêm cấu hình theo loại
            </Button>
          </div>
          <CardDescription className="text-xs text-muted-foreground mt-1">
            Tùy chỉnh ngưỡng phát hiện quét bất thường riêng biệt cho từng loại nông sản có chu kỳ phân phối hoặc tính chất riêng.
          </CardDescription>
        </CardHeader>
