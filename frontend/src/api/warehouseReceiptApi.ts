...
/** Ghi nhận sự kiện nhập kho HTX POST /api/v1/chain-events/warehouse-receipt */
...
/** Lấy chi tiết sự kiện nhập kho HTX theo ID sự kiện GET /api/v1/chain-events/warehouse-receipts/{eventId} */
