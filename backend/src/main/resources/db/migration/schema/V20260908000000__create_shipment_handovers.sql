...
--
-- LƯU Ý: Phải khai báo COLLATE=utf8mb4_unicode_ci để đồng bộ collation với các
--   bảng cha (shipments, organizations, users) đang dùng utf8mb4_unicode_ci.
--   Nếu không khai báo, MySQL sẽ dùng collation_server (utf8mb4_0900_ai_ci trên
--   AWS RDS MySQL 8.0), khác với utf8mb4_unicode_ci của bảng cha, gây lỗi 3780
--   (foreign key mismatch) khi tạo CONSTRAINT FOREIGN KEY.
--
