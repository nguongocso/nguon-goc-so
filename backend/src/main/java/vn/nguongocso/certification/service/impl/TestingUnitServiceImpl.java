...
public class TestingUnitServiceImpl implements TestingUnitService {
        ...
        private static final String MSG_NO_PERMISSION = "Bạn không có quyền quản lý danh mục đơn vị kiểm nghiệm.";
        private static final String MSG_UNIT_NOT_FOUND = "Đơn vị kiểm nghiệm không tồn tại.";
        private static final String MSG_UNIT_NAME_EXISTS = "Tên đơn vị kiểm nghiệm đã tồn tại, vui lòng chọn tên khác.";

        private final TestingUnitRepository testingUnitRepository;
        private final ApplicationEventPublisher eventPublisher;

        /**
         * Thêm mới đơn vị kiểm nghiệm vào hệ thống.
         */
        @Override
        ...
        /**
         * Lấy danh sách đơn vị kiểm nghiệm có phân trang.
         */
        @Override
        ...
        /**
         * Vô hiệu hoá đơn vị kiểm nghiệm theo cơ chế xoá mềm.
         */
        @Override
        ...
        /**
         * Chuyển đổi thực thể đơn vị kiểm nghiệm sang DTO phản hồi.
         */
