...
@Transactional
public class AccreditationScopeServiceImpl implements AccreditationScopeService {
        private static final String ADMIN_ROLE = "VT-01";
        private static final String MSG_NO_PERMISSION = "Bạn không có quyền quản lý phạm vi công nhận của đơn vị kiểm nghiệm.";
        private static final String MSG_UNIT_NOT_FOUND = "Đơn vị kiểm nghiệm không tồn tại.";
        private static final String MSG_CRITERIA_EMPTY = "Danh sách chỉ tiêu không được để trống.";
        private static final String MSG_CRITERION_NOT_FOUND = "Một hoặc nhiều chỉ tiêu không tồn tại trong danh mục dùng chung.";
        private static final String MSG_CRITERION_INACTIVE = "Một hoặc nhiều chỉ tiêu đã ngừng sử dụng, không thể gán vào phạm vi công nhận.";
        ...
        /**
         * Lấy phạm vi công nhận hiện tại của đơn vị kiểm nghiệm.
         */
        @Override
        ...
        public AccreditationScopeSummaryResponse getAccreditationScope(
                ...
                List<AccreditationScope> scopes = accreditationScopeRepository
                                .findByTestingUnitIdWithCriterion(testingUnitId);
        ...
        public AccreditationScopeSummaryResponse updateAccreditationScope(
                ...
                List<InspectionCriterionCatalog> criteria = inspectionCriterionCatalogRepository
                                .findByIdIn(distinctIds);
        ...
        /**
         * Xây dựng DTO phản hồi tóm tắt phạm vi công nhận của đơn vị kiểm nghiệm.
         */
        private AccreditationScopeSummaryResponse buildSummary(
                ...
                return AccreditationScopeSummaryResponse.builder()
                                ...
                                .accreditedCriteria(
                                                scopes.stream()
                                                                .map(scope -> AccreditationScopeSummaryResponse.AccreditedCriterionItem
                                                                                .builder()
        ...
        /**
         * Ghi nhật ký hoạt động của người dùng vào hệ thống.
         */
