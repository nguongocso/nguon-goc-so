...
public class StandardServiceImpl implements StandardService {
        ...
        public StandardResponse updateStandard(
                ...
                standard.setNameEn(request.getNameEn() != null && !request.getNameEn().trim().isBlank()
                                ? request.getNameEn().trim()
                                : null);
        ...
        public Page<StandardResponse> getStandards(
                        Boolean isActive,
                        Pageable pageable,
                        CustomUserDetails currentUser) {
                Page<Standard> page;
        ...
        /**
         * Chuyển đổi thực thể tiêu chuẩn sang DTO phản hồi.
         */
