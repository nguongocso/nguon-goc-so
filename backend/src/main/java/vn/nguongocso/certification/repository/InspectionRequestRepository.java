...
public interface InspectionRequestRepository
    ...
    /**
     * Lấy danh sách yêu cầu kiểm nghiệm theo tổ chức sở hữu lô sản xuất.
     *
     * @param organizationId ID của tổ chức hiện tại.
     * @param pageable       Thông tin phân trang.
     * @return Trang yêu cầu kiểm nghiệm thuộc tổ chức.
     */
    ...
    /**
     * Lấy danh sách yêu cầu kiểm nghiệm theo tổ chức sở hữu lô sản xuất và
     * trạng thái.
     *
     * @param organizationId ID của tổ chức hiện tại.
     * @param status         Trạng thái yêu cầu kiểm nghiệm.
     * @param pageable       Thông tin phân trang.
     * @return Trang yêu cầu kiểm nghiệm thuộc tổ chức.
     */
