...
/**
 * Repository thao tác với tiêu chuẩn chứng nhận (Standard).
 */
public interface StandardRepository
                extends JpaRepository<Standard, UUID> {
        /**
        ...
        /**
         * Lấy danh sách tiêu chuẩn theo trạng thái hoạt động có phân trang.
         */
