...
/**
 * Repository quản lý các đề nghị thu hồi hàng loạt (NCL-08-CN-011).
 */
@Repository
public interface BulkRecallRequestRepository extends JpaRepository<BulkRecallRequest, UUID> {

    /**
     * Tìm đề nghị theo ID và tổ chức của lô sản xuất.
     */
    ...
    /**
     * Tìm đề nghị theo ID với pessimistic lock để tránh concurrent approval.
     */
