...
public class TestUserBootstrap {
    ...
    /** Dữ liệu đóng gói thông tin người dùng và mã JWT phục vụ kiểm thử runtime. */
    @Getter
    @AllArgsConstructor
    ...
    /** Khởi tạo các vai trò và người dùng mẫu, gán vào tổ chức và sinh mã JWT truy cập. */
