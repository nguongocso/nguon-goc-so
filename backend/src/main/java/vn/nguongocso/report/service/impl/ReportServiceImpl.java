...
public class ReportServiceImpl implements ReportService {
    ...
    /** Kiểm tra từ ngày nhỏ hơn hoặc bằng đến ngày. */
    ...
    /** Xây dựng báo cáo tổng hợp trong phạm vi được phép. */
    ...
    /** Trả về response rỗng khi tài khoản chưa được phân công địa bàn. */
