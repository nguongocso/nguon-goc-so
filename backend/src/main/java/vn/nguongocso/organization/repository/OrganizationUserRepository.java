...
public interface OrganizationUserRepository extends JpaRepository<OrganizationUser, UUID> {
     ...
     * @return Optional chứa người dùng trong tổ chức nếu tìm thấy, hoặc rỗng nếu không tìm thấy
     */
     ...
     *
     * @param user người dùng
     * @return Optional chứa người dùng đầu tiên trong tổ chức nếu tìm thấy, hoặc rỗng nếu không tìm thấy
     */
     ...
     * @param status trạng thái của người dùng trong tổ chức
     * @return danh sách người dùng trong tổ chức phù hợp
     */
    List<OrganizationUser> findByOrganization_OrganizationIdAndStatus(UUID orgId, OrganizationUserStatus status);
