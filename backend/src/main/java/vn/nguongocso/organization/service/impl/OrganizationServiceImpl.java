...
public class OrganizationServiceImpl implements OrganizationService {
    ...
    /** Kiểm tra email và số điện thoại không trùng với tổ chức khác. */
    ...
    /** Áp dụng đơn vị hành chính cho tổ chức và kiểm tra tính hợp lệ. */
    ...
    @Override
    @Transactional
    public OrganizationUserResponse addExistingUserToOrganization(UUID organizationId, UUID userId, Integer roleId) {
        Organization org = organizationRepository.findById(organizationId)
                .orElseThrow(() -> new BusinessException("Tổ chức không tồn tại"));
