...
public interface LoginAttemptRepository extends JpaRepository<LoginAttempt, UUID> {
    /**
     * Lấy lịch sử đăng nhập của một người dùng, sắp xếp theo thời gian mới nhất
     * trước.
     */
    ...
    /**
     * Lấy top 5 lần đăng nhập gần nhất có kết quả cho trước, sắp xếp mới nhất
     * trước.
    ...
    /**
     * Kiểm tra xem một tài khoản đã từng đăng nhập thành công từ quốc gia nào đó
     * không.
     */
    ...
    /**
     * Kiểm tra xem một tài khoản đã từng đăng nhập từ quốc gia nào đó
     * không.
     */
    ...
    /**
     * Lấy các lần đăng nhập FAILED của người dùng trong khoảng thời gian (dùng để
     * phát hiện repeated failed login).
     */
