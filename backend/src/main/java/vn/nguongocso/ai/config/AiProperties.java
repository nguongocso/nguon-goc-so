...
public class AiProperties {
     ...
     */
    private String model = "gemini-2.0-flash,gemini-1.5-flash,gemini-2.5-flash,gemini-3-flash-preview";
    ...
    public List<String> getModelList() {
        if (model == null || model.isBlank()) {
            return List.of("gemini-2.0-flash", "gemini-1.5-flash", "gemini-2.5-flash", "gemini-3-flash-preview");
        }
